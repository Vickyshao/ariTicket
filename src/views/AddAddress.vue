<template>
    <div class="add_addres">
        ...
        <div class="default" @click="defaulta = !defaulta" >
            <span class="iconfont radio" :class="{'icon-danxuankuangweixuan':!defaulta,'icon-danxuankuangyixuan':defaulta}"></span><span class="text fontSize30">设为默认地址</span>
        </div>
        <div class="sure_btn">
        ...
        //验证通过后提交
         ...
         let Area = this.$store.state.order.Area
          let obj = {
            ...
            defaultaddress:this.defaulta ? '1':'0',//默认配送
